...
class MyGroupsNewMemberState extends Equatable {
  ...
  MyGroupsNewMemberState copyWith(
      {String? firstName,
      String? secondName,
      String? lastName,
      ...
      MyGroupsInfo? info,
      String? errorMessage,
      bool? relationHasErrors}) {
    return MyGroupsNewMemberState(
